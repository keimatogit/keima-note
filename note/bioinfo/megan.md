...
[MEGAN community](http://megan.informatik.uni-tuebingen.de/)

```
conda acreat -n megan
conda install -c bioconda megan
```

blast2lcaは並列化されておらず大きいデータは無理。

blast2rma
```
blast2rma \
 --threads 44 \
 -mdb ~/db/megan/megan-map-Jan2021.db \
 -i sample.blast \
 -o sample.blast.rma \
 -f BlastTab \
 --topPercent 10 \
...
AUTHOR(s)
	Daniel H. Huson.
VERSION
	MEGAN Community Edition (version 6.21.7, built 23 Jun 2021).
