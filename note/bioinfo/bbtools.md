...
BBtoolsはいろんなツールのセット。ペアエンドレスをマージするbbmergeを使った。

[macでインフォマティクス- 多機能なNGS分析ツール BBtools 其の１](https://kazumaxneo.hatenablog.com/entry/2017/08/29/162219)
[BBMerge Guide](https://jgi.doe.gov/data-and-tools/software-tools/bbtools/bb-tools-user-guide/bbmerge-guide/)
...
```
sbatch -J bbmerge -o slurm_bbmerge_%j.out -p c6420 -t 22 --wrap="\
 bbmerge.sh \
  in1=NKTAall_cut_R1.fastq.gz \
  in2=NKTAall_cut_R2.fastq.gz \
  out=NKTAall_cut_merged.fastq.gz \
  outu1=NKTAall_cut_R1_unmerged.fastq \
  outu2=NKTAall_cut_R2_unmerged.fastq"
 gzip NKTAall_cut_R1_unmerged.fastq NKTAall_cut_R2_unmerged.fastq
```